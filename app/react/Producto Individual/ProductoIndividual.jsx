...
<ButtonX onClick ={onCloseClick}><ImgX src ={X}/></ButtonX>
</DivC>
<DivP>
{Prueba.map(element => {
 return(
...
<DivP >
<Text> Un elemento posicionado es un elemento cuyo valor computado de position es relative, absolute, fixed, o sticky. (En otras palabras, cualquiera excepto static).
...
<DivO >
<DivC>
<ButtonX4 onClick ={onCloseClick}><ImgX src ={X}/></ButtonX4>
</DivC>
<DivM>
...
<ButtonX onClick ={onCloseClick}><ImgX2 src ={XWhite}/></ButtonX>
   </HeaderDiv>
<DivScroll>
{ Prueba.map(elem =>
    <>
